...
#include <towr_plus/models/examples/draco3_crbi_helper.h>

namespace towr_plus {

class Draco3CompositeRigidBodyInertia : public CompositeRigidBodyInertia {
public:
  Draco3CompositeRigidBodyInertia();
  virtual ~Draco3CompositeRigidBodyInertia();
